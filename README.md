...
This may force an update to `allowed-scripts.mjs` which will need to be manually resolved, the terminal output will outline exactly what changes need to be made
...
Current configuration: {
  ...
  "node_modules/node@22.16.0": "<MISSING>",
  "node_modules/node@22.21.1": "<REMOVED>",
 ...
 * node_modules/node@22.16.0 (package published: 2025-05-22 01:37)
        scripts:
