...
const authUrl = 'http://127.0.0.1:9091/__admin'
const probationUrl = 'http://127.0.0.1:9091/__admin'
const allocationUrl = 'http://127.0.0.1:9091/__admin'
const workloadUrl = 'http://127.0.0.1:9091/__admin'
const userPreferenceUrl = 'http://127.0.0.1:9091/__admin'
const staffLookupUrl = 'http://127.0.0.1:9091/__admin'
const manageUsersLookupUrl = 'http://127.0.0.1:9091/__admin'
